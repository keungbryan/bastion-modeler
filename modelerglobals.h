...
{ 
	XPOS, YPOS, ZPOS, XROTATE, YROTATE, ZROTATE, UPPER_BODY_ROTATE, LOWER_BODY_ROTATE, HEAD_ROTATE, HEAD_X_TILT, HEAD_Z_TILT, 
...
#define SET(x, val) (ModelerApplication::Instance()->SetControlValue(x, val))
#endif